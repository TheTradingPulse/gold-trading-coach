...
p.add_argument("--future-bars",type=int,default=240)
p.add_argument("--min-score10",type=float)
p.add_argument("--tier")
...
for symbol in symbols:
    print(json.dumps(b.run_symbol(symbol,a.timeframe,a.warmup,a.step,a.future_bars,
                                  a.min_score10,a.tier,a.max_events),indent=2))
